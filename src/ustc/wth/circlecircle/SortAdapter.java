...
//			view = LayoutInflater.from(mContext).inflate(R.layout.contact_line, null);
//			viewHolder.tvTitle = (TextView) view.findViewById(R.id.contact_textview);
//			viewHolder.tvLetter = (TextView) view.findViewById(R.id.contact_num);
